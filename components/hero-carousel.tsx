...
const defaultSlides = [
  {
    ...
    imageUrl: "/humanitarian-aid-middle-east.jpg",
  ...
  {
    id: "default-2",
    titleEn: "Clean Water Saves Lives",
    titleTr: "Temiz Su Hayat Kurtarır",
    subtitleEn: "Help us build water wells in underserved communities around the world.",
    subtitleTr: "Dünyanın dört bir yanındaki yoksun topluluklarda su kuyuları inşa etmemize yardım edin.",
    imageUrl: "/water-well-village-africa.jpg",
    buttonTextEn: "Support Water Projects",
    buttonTextTr: "Su Projelerini Destekle",
    linkUrl: "/donate?campaign=clean-water",
  },
  {
    id: "default-3",
    titleEn: "Medical Aid for All",
    titleTr: "Herkes İçin Tıbbi Yardım",
    subtitleEn: "Providing essential medical care to those who need it most.",
    subtitleTr: "En çok ihtiyacı olanlara temel tıbbi bakım sağlıyoruz.",
    imageUrl: "/medical-eye-surgery-africa.jpg",
